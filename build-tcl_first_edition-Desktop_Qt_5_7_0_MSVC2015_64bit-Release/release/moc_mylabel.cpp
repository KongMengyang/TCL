...
#include "../../tcl_first_edition/mylabel.h"
...
QT_MOC_LITERAL(1, 8, 14), // "instructSignal"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 5), // "index"
QT_MOC_LITERAL(4, 30, 12) // "updateSignal"

    },
    "myLabel\0instructSignal\0\0index\0"
    "updateSignal"
};
...
void myLabel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->instructSignal((*reinterpret_cast< int(*)>(_a[1]))); break;
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&myLabel::instructSignal)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&myLabel::updateSignal)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void myLabel::instructSignal(int _t1)
{
